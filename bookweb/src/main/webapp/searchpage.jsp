...
<body>
	...
	<div style="text-align: center;">
        ...
        <div style="font-size: 30px;">查詢貼文關鍵字</div>
        <!-- 以keyword作為Servlet裡參數名稱 -->
        <div> <input type="text" id="text" name="keyword"> </div>
        <br>
        <div> <button type="submit" name="searcharticle" onclick="javascript:location.href='searchresult.jsp'">查詢</button></div>
        </form>
    </div>
</body>
</html>