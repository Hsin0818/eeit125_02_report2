               ...
               <div class="row">
                    ...
                    <div class="col-sm-11">
                        ...
                        <div class="back">
                            ...
                            <br><span>作者：</sapn><input type="text" name="bookwriter" value="<%=bookData.getBk_Author() %>"><br>
                            <br><span>出版社：</sapn><input type="text" name="bookpublish" value="<%=bookData.getBk_Publish() %>"><br>
                            <br><span>出版日期：</sapn><input type="text" name="booktime" value="<%=bookData.getBk_Date() %>"><br>
                            <br>
                            <figure>
                                <span>內容簡介：</span>
                                <div class="context">
